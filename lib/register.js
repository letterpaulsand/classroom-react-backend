...
function register(data, time) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var file, adapter, db, typeAllData, typeAllDataFilter;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    typeAllDataFilter = typeAllData === null || typeAllData === void 0 ? void 0 : typeAllData.filter(function (item) { return item.name === data.name; });
                    if (!empty(typeAllDataFilter)) {
                        // name repeat
                        return [2 /*return*/, status(401, 'name has been used')];
                    }
                    (_b = db.data) === null || _b === void 0 ? void 0 : _b.type.push({
                        email: data.email,
