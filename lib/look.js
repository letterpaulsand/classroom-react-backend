...
function look(data) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var file, adapter, db, myTypeProfileArray, myTypeProfile, myTypeProfileDate, dataAllData, resultData, dateExpiration, i, resultObj;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (data.number > 0) {
                        return [2 /*return*/, status(404, 'over range')];
                    }
                ...
                case 1:
                    _c.sent();
                    myTypeProfileArray = (_a = db.data) === null || _a === void 0 ? void 0 : _a.type.filter(function (item) { return item.name == data.name; });
                    ...
                    myTypeProfileDate = myTypeProfile.date[-data.number];
                    dataAllData = (_b = db.data) === null || _b === void 0 ? void 0 : _b.data;
                    if (empty(dataAllData) || dataAllData === undefined) {
                        return [2 /*return*/, status(500, 'server error')];
                    }
                    resultData = [];
                    dateExpiration = false;
                    for (i = (dataAllData === null || dataAllData === void 0 ? void 0 : dataAllData.length) - 1; i >= -1; i--) {
                        if (i !== -1 && dataAllData[i].date === myTypeProfileDate) {
                            ...
                            return [2 /*return*/, status(200, 'success', [resultObj])];
                        }
                    }
                    return [2 /*return*/];
            }
